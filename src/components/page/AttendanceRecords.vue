    ...
    <div class="table">
        ...
        <div class="handle-box">
            ...
            <el-select size="small" v-model="select_cate" placeholder="选择班级" class="handle-select mr10">
                ...
                &nbsp;&nbsp;&nbsp; 状态：
                <el-select size="small" v-model="select_cate" placeholder="" class="handle-select mr10">
                <el-option key="0" label="" value=""></el-option>
        ...
        <el-collapse v-model="activeNames">
            <el-collapse-item title="学员考勤信息列表" name="1">
                <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column prop="number12" label="日期">     </el-table-column>
                    <el-table-column prop="number12" label="开始时间">        </el-table-column>
                    <el-table-column prop="number12" label="结束时间">        </el-table-column>
                    <el-table-column prop="number12" label="状态">        </el-table-column>
                </el-table>
